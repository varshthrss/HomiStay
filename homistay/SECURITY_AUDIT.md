...
| 17 | **No input sanitization on rendered user text** — user profile fields (name, bio) are rendered directly in JSX. React escapes by default, but any `dangerouslySetInnerHTML` usage would bypass this. |
